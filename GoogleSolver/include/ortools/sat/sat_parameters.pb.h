...
#ifndef PROTOBUF_ortools_2fsat_2fsat_5fparameters_2eproto__INCLUDED
#define PROTOBUF_ortools_2fsat_2fsat_5fparameters_2eproto__INCLUDED
...
namespace protobuf_ortools_2fsat_2fsat_5fparameters_2eproto {
...
class SatParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.sat.SatParameters) */ {
 public:
  ...
  inline SatParameters* New() const PROTOBUF_FINAL { return New(NULL); }

  SatParameters* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  bool has_use_fixed_search() const;
  void clear_use_fixed_search();
  static const int kUseFixedSearchFieldNumber = 82;
  bool use_fixed_search() const;
  void set_use_fixed_search(bool value);
  ...
  bool has_use_global_lp_constraint() const;
  void clear_use_global_lp_constraint();
  static const int kUseGlobalLpConstraintFieldNumber = 81;
  bool use_global_lp_constraint() const;
  void set_use_global_lp_constraint(bool value);
 ...
 private:
  ...
  void set_has_initial_polarity();
  void clear_has_initial_polarity();
  void set_has_use_phase_saving();
  void clear_has_use_phase_saving();
  void set_has_random_polarity_ratio();
  void clear_has_random_polarity_ratio();
  void set_has_random_branches_ratio();
  void clear_has_random_branches_ratio();
  void set_has_literal_ordering();
  void clear_has_literal_ordering();
  void set_has_use_erwa_heuristic();
  void clear_has_use_erwa_heuristic();
  void set_has_initial_variables_activity();
  void clear_has_initial_variables_activity();
  void set_has_also_bump_variables_in_conflict_reasons();
  void clear_has_also_bump_variables_in_conflict_reasons();
  void set_has_minimization_algorithm();
  void clear_has_minimization_algorithm();
  void set_has_binary_minimization_algorithm();
  void clear_has_binary_minimization_algorithm();
  void set_has_subsumption_during_conflict_analysis();
  void clear_has_subsumption_during_conflict_analysis();
  void set_has_clause_cleanup_period();
  void clear_has_clause_cleanup_period();
  void set_has_clause_cleanup_target();
  void clear_has_clause_cleanup_target();
  void set_has_clause_cleanup_protection();
  void clear_has_clause_cleanup_protection();
  void set_has_clause_cleanup_lbd_bound();
  void clear_has_clause_cleanup_lbd_bound();
  void set_has_clause_cleanup_ordering();
  void clear_has_clause_cleanup_ordering();
  void set_has_pb_cleanup_increment();
  void clear_has_pb_cleanup_increment();
  void set_has_pb_cleanup_ratio();
  void clear_has_pb_cleanup_ratio();
  void set_has_variable_activity_decay();
  void clear_has_variable_activity_decay();
  void set_has_max_variable_activity_value();
  void clear_has_max_variable_activity_value();
  void set_has_glucose_max_decay();
  void clear_has_glucose_max_decay();
  void set_has_glucose_decay_increment();
  void clear_has_glucose_decay_increment();
  void set_has_glucose_decay_increment_period();
  void clear_has_glucose_decay_increment_period();
  void set_has_clause_activity_decay();
  void clear_has_clause_activity_decay();
  void set_has_max_clause_activity_value();
  void clear_has_max_clause_activity_value();
  void set_has_use_glucose_bump_again_strategy();
  void clear_has_use_glucose_bump_again_strategy();
  void set_has_default_restart_algorithms();
  void clear_has_default_restart_algorithms();
  void set_has_luby_restart_period();
  void clear_has_luby_restart_period();
  void set_has_restart_running_window_size();
  void clear_has_restart_running_window_size();
  void set_has_restart_dl_average_ratio();
  void clear_has_restart_dl_average_ratio();
  void set_has_restart_lbd_average_ratio();
  void clear_has_restart_lbd_average_ratio();
  void set_has_use_blocking_restart();
  void clear_has_use_blocking_restart();
  void set_has_blocking_restart_window_size();
  void clear_has_blocking_restart_window_size();
  void set_has_blocking_restart_multiplier();
  void clear_has_blocking_restart_multiplier();
  void set_has_num_conflicts_before_strategy_changes();
  void clear_has_num_conflicts_before_strategy_changes();
  void set_has_strategy_change_increase_ratio();
  void clear_has_strategy_change_increase_ratio();
  ...
  void set_has_max_number_of_conflicts();
  void clear_has_max_number_of_conflicts();
  void set_has_max_memory_in_mb();
  void clear_has_max_memory_in_mb();
  void set_has_treat_binary_clauses_separately();
  void clear_has_treat_binary_clauses_separately();
  void set_has_random_seed();
  void clear_has_random_seed();
  void set_has_log_search_progress();
  void clear_has_log_search_progress();
  void set_has_use_pb_resolution();
  void clear_has_use_pb_resolution();
  void set_has_minimize_reduction_during_pb_resolution();
  void clear_has_minimize_reduction_during_pb_resolution();
  void set_has_count_assumption_levels_in_lbd();
  void clear_has_count_assumption_levels_in_lbd();
  void set_has_presolve_bve_threshold();
  void clear_has_presolve_bve_threshold();
  void set_has_presolve_bve_clause_weight();
  void clear_has_presolve_bve_clause_weight();
  void set_has_presolve_probing_deterministic_time_limit();
  void clear_has_presolve_probing_deterministic_time_limit();
  void set_has_presolve_blocked_clause();
  void clear_has_presolve_blocked_clause();
  void set_has_presolve_use_bva();
  void clear_has_presolve_use_bva();
  void set_has_presolve_bva_threshold();
  void clear_has_presolve_bva_threshold();
  void set_has_use_optimization_hints();
  void clear_has_use_optimization_hints();
  void set_has_minimize_core();
  void clear_has_minimize_core();
  void set_has_find_multiple_cores();
  void clear_has_find_multiple_cores();
  void set_has_cover_optimization();
  void clear_has_cover_optimization();
  void set_has_max_sat_assumption_order();
  void clear_has_max_sat_assumption_order();
  void set_has_max_sat_reverse_assumption_order();
  void clear_has_max_sat_reverse_assumption_order();
  void set_has_max_sat_stratification();
  void clear_has_max_sat_stratification();
  void set_has_use_precedences_in_disjunctive_constraint();
  void clear_has_use_precedences_in_disjunctive_constraint();
  void set_has_use_overload_checker_in_cumulative_constraint();
  void clear_has_use_overload_checker_in_cumulative_constraint();
  void set_has_use_timetable_edge_finding_in_cumulative_constraint();
  void clear_has_use_timetable_edge_finding_in_cumulative_constraint();
  void set_has_use_disjunctive_constraint_in_cumulative_constraint();
  void clear_has_use_disjunctive_constraint_in_cumulative_constraint();
  void set_has_use_global_lp_constraint();
  void clear_has_use_global_lp_constraint();
  void set_has_use_fixed_search();
  void clear_has_use_fixed_search();
  void set_has_optimize_with_core();
  void clear_has_optimize_with_core();
  void set_has_optimize_with_max_hs();
  void clear_has_optimize_with_max_hs();
  void set_has_cp_model_presolve();
  void clear_has_cp_model_presolve();
  void set_has_enumerate_all_solutions();
  void clear_has_enumerate_all_solutions();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<3> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedField<int> restart_algorithms_;
  static ::google::protobuf::internal::ExplicitlyConstructed< ::std::string> _default_default_restart_algorithms_;
  ...
  bool use_global_lp_constraint_;
  bool cp_model_presolve_;
  friend struct  protobuf_ortools_2fsat_2fsat_5fparameters_2eproto::TableStruct;
};
// ===================================================================
...
inline void SatParameters::clear_default_restart_algorithms() {
  default_restart_algorithms_.ClearToDefaultNoArena(&SatParameters::_default_default_restart_algorithms_.get());
...
inline void SatParameters::set_default_restart_algorithms(const ::std::string& value) {
  ...
  default_restart_algorithms_.SetNoArena(&SatParameters::_default_default_restart_algorithms_.get(), value);
...
inline void SatParameters::set_default_restart_algorithms(::std::string&& value) {
  ...
  default_restart_algorithms_.SetNoArena(
    &SatParameters::_default_default_restart_algorithms_.get(), std::move(value));
...
inline void SatParameters::set_default_restart_algorithms(const char* value) {
  set_has_default_restart_algorithms();
  default_restart_algorithms_.SetNoArena(&SatParameters::_default_default_restart_algorithms_.get(), ::std::string(value));
...
inline void SatParameters::set_default_restart_algorithms(const char* value, size_t size) {
  set_has_default_restart_algorithms();
  default_restart_algorithms_.SetNoArena(&SatParameters::_default_default_restart_algorithms_.get(),
...
inline ::std::string* SatParameters::mutable_default_restart_algorithms() {
  ...
  return default_restart_algorithms_.MutableNoArena(&SatParameters::_default_default_restart_algorithms_.get());
}
inline ::std::string* SatParameters::release_default_restart_algorithms() {
  ...
  clear_has_default_restart_algorithms();
  return default_restart_algorithms_.ReleaseNoArena(&SatParameters::_default_default_restart_algorithms_.get());
}
inline void SatParameters::set_allocated_default_restart_algorithms(::std::string* default_restart_algorithms) {
  ...
  default_restart_algorithms_.SetAllocatedNoArena(&SatParameters::_default_default_restart_algorithms_.get(), default_restart_algorithms);
...
inline void SatParameters::set_has_presolve_blocked_clause() {
  _has_bits_[1] |= 0x08000000u;
}
inline void SatParameters::clear_has_presolve_blocked_clause() {
  _has_bits_[1] &= ~0x08000000u;
}
inline void SatParameters::clear_presolve_blocked_clause() {
  presolve_blocked_clause_ = true;
  clear_has_presolve_blocked_clause();
}
...
inline void SatParameters::set_presolve_blocked_clause(bool value) {
  set_has_presolve_blocked_clause();
...
inline void SatParameters::set_has_find_multiple_cores() {
  _has_bits_[1] |= 0x80000000u;
}
inline void SatParameters::clear_has_find_multiple_cores() {
  _has_bits_[1] &= ~0x80000000u;
}
inline void SatParameters::clear_find_multiple_cores() {
  find_multiple_cores_ = true;
  clear_has_find_multiple_cores();
}
...
inline void SatParameters::set_has_cover_optimization() {
  _has_bits_[2] |= 0x00000001u;
}
inline void SatParameters::clear_has_cover_optimization() {
  _has_bits_[2] &= ~0x00000001u;
}
inline void SatParameters::clear_cover_optimization() {
  cover_optimization_ = true;
  clear_has_cover_optimization();
}
...
inline void SatParameters::set_has_use_overload_checker_in_cumulative_constraint() {
  _has_bits_[0] |= 0x00080000u;
}
inline void SatParameters::clear_has_use_overload_checker_in_cumulative_constraint() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void SatParameters::clear_use_overload_checker_in_cumulative_constraint() {
  ...
  clear_has_use_overload_checker_in_cumulative_constraint();
}
...
inline void SatParameters::set_has_use_timetable_edge_finding_in_cumulative_constraint() {
  _has_bits_[0] |= 0x00100000u;
}
inline void SatParameters::clear_has_use_timetable_edge_finding_in_cumulative_constraint() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void SatParameters::clear_use_timetable_edge_finding_in_cumulative_constraint() {
  ...
  clear_has_use_timetable_edge_finding_in_cumulative_constraint();
}
...
inline void SatParameters::set_has_use_disjunctive_constraint_in_cumulative_constraint() {
  _has_bits_[2] |= 0x00000004u;
}
inline void SatParameters::clear_has_use_disjunctive_constraint_in_cumulative_constraint() {
  _has_bits_[2] &= ~0x00000004u;
}
inline void SatParameters::clear_use_disjunctive_constraint_in_cumulative_constraint() {
  ...
  clear_has_use_disjunctive_constraint_in_cumulative_constraint();
}
...
// optional bool use_global_lp_constraint = 81 [default = true];
inline bool SatParameters::has_use_global_lp_constraint() const {
  return (_has_bits_[2] & 0x00000010u) != 0;
}
inline void SatParameters::set_has_use_global_lp_constraint() {
  _has_bits_[2] |= 0x00000010u;
}
inline void SatParameters::clear_has_use_global_lp_constraint() {
  _has_bits_[2] &= ~0x00000010u;
}
inline void SatParameters::clear_use_global_lp_constraint() {
  use_global_lp_constraint_ = true;
  clear_has_use_global_lp_constraint();
}
inline bool SatParameters::use_global_lp_constraint() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.use_global_lp_constraint)
  return use_global_lp_constraint_;
}
inline void SatParameters::set_use_global_lp_constraint(bool value) {
  set_has_use_global_lp_constraint();
  use_global_lp_constraint_ = value;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.use_global_lp_constraint)
}

// optional bool use_fixed_search = 82 [default = false];
inline bool SatParameters::has_use_fixed_search() const {
  return (_has_bits_[0] & 0x00200000u) != 0;
}
inline void SatParameters::set_has_use_fixed_search() {
  _has_bits_[0] |= 0x00200000u;
}
inline void SatParameters::clear_has_use_fixed_search() {
  _has_bits_[0] &= ~0x00200000u;
}
inline void SatParameters::clear_use_fixed_search() {
  use_fixed_search_ = false;
  clear_has_use_fixed_search();
}
inline bool SatParameters::use_fixed_search() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.use_fixed_search)
  return use_fixed_search_;
}
inline void SatParameters::set_use_fixed_search(bool value) {
  set_has_use_fixed_search();
  use_fixed_search_ = value;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.use_fixed_search)
}
...
inline void SatParameters::set_has_optimize_with_core() {
  _has_bits_[0] |= 0x00400000u;
}
inline void SatParameters::clear_has_optimize_with_core() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void SatParameters::clear_optimize_with_core() {
  optimize_with_core_ = false;
  clear_has_optimize_with_core();
}
...
inline void SatParameters::set_has_optimize_with_max_hs() {
  _has_bits_[0] |= 0x00800000u;
}
inline void SatParameters::clear_has_optimize_with_max_hs() {
  _has_bits_[0] &= ~0x00800000u;
}
inline void SatParameters::clear_optimize_with_max_hs() {
  optimize_with_max_hs_ = false;
  clear_has_optimize_with_max_hs();
}
...
inline void SatParameters::set_has_cp_model_presolve() {
  _has_bits_[2] |= 0x00000020u;
}
inline void SatParameters::clear_has_cp_model_presolve() {
  _has_bits_[2] &= ~0x00000020u;
}
inline void SatParameters::clear_cp_model_presolve() {
  cp_model_presolve_ = true;
  clear_has_cp_model_presolve();
}
...
inline void SatParameters::set_has_enumerate_all_solutions() {
  _has_bits_[0] |= 0x01000000u;
}
inline void SatParameters::clear_has_enumerate_all_solutions() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void SatParameters::clear_enumerate_all_solutions() {
  enumerate_all_solutions_ = false;
  clear_has_enumerate_all_solutions();
}
...
inline void SatParameters::set_enumerate_all_solutions(bool value) {
  set_has_enumerate_all_solutions();
...
#endif  // PROTOBUF_ortools_2fsat_2fsat_5fparameters_2eproto__INCLUDED
