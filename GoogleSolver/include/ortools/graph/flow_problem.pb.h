...
#ifndef PROTOBUF_ortools_2fgraph_2fflow_5fproblem_2eproto__INCLUDED
#define PROTOBUF_ortools_2fgraph_2fflow_5fproblem_2eproto__INCLUDED
...
namespace protobuf_ortools_2fgraph_2fflow_5fproblem_2eproto {
...
class Arc : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.Arc) */ {
 public:
  ...
  inline Arc* New() const PROTOBUF_FINAL { return New(NULL); }

  Arc* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  void set_has_tail_node_id();
  void clear_has_tail_node_id();
  void set_has_head_node_id();
  void clear_has_head_node_id();
  void set_has_capacity();
  void clear_has_capacity();
  void set_has_unit_cost();
  void clear_has_unit_cost();
  ...
  friend struct  protobuf_ortools_2fgraph_2fflow_5fproblem_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class FlowModel : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.FlowModel) */ {
 public:
  ...
  inline FlowModel* New() const PROTOBUF_FINAL { return New(NULL); }

  FlowModel* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
#endif  // PROTOBUF_ortools_2fgraph_2fflow_5fproblem_2eproto__INCLUDED
