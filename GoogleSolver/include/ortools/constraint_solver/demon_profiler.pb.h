...
class DemonRuns : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.DemonRuns) */ {
 public:
  ...
  inline DemonRuns* New() const PROTOBUF_FINAL { return New(NULL); }

  DemonRuns* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class ConstraintRuns : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.ConstraintRuns) */ {
 public:
  ...
  inline ConstraintRuns* New() const PROTOBUF_FINAL { return New(NULL); }

  ConstraintRuns* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
