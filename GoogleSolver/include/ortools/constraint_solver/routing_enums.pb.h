...
class FirstSolutionStrategy : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.FirstSolutionStrategy) */ {
 public:
  ...
  inline FirstSolutionStrategy* New() const PROTOBUF_FINAL { return New(NULL); }

  FirstSolutionStrategy* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class LocalSearchMetaheuristic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.LocalSearchMetaheuristic) */ {
 public:
  ...
  inline LocalSearchMetaheuristic* New() const PROTOBUF_FINAL { return New(NULL); }

  LocalSearchMetaheuristic* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
