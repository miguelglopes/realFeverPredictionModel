...
#ifndef PROTOBUF_ortools_2fbop_2fbop_5fparameters_2eproto__INCLUDED
...
namespace protobuf_ortools_2fbop_2fbop_5fparameters_2eproto {
...
class BopOptimizerMethod : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.bop.BopOptimizerMethod) */ {
 public:
  ...
  inline BopOptimizerMethod* New() const PROTOBUF_FINAL { return New(NULL); }

  BopOptimizerMethod* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  int type_;
  friend struct  protobuf_ortools_2fbop_2fbop_5fparameters_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class BopSolverOptimizerSet : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.bop.BopSolverOptimizerSet) */ {
 public:
  ...
  inline BopSolverOptimizerSet* New() const PROTOBUF_FINAL { return New(NULL); }

  BopSolverOptimizerSet* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class BopParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.bop.BopParameters) */ {
 public:
  ...
  inline BopParameters* New() const PROTOBUF_FINAL { return New(NULL); }

  BopParameters* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  void set_has_lp_max_deterministic_time();
  void clear_has_lp_max_deterministic_time();
  void set_has_max_number_of_consecutive_failing_optimizer_calls();
  void clear_has_max_number_of_consecutive_failing_optimizer_calls();
  void set_has_relative_gap_limit();
  void clear_has_relative_gap_limit();
  void set_has_max_num_decisions_in_ls();
  void clear_has_max_num_decisions_in_ls();
  void set_has_max_num_broken_constraints_in_ls();
  void clear_has_max_num_broken_constraints_in_ls();
  void set_has_log_search_progress();
  void clear_has_log_search_progress();
  void set_has_compute_estimated_impact();
  void clear_has_compute_estimated_impact();
  void set_has_prune_search_tree();
  void clear_has_prune_search_tree();
  void set_has_sort_constraints_by_num_terms();
  void clear_has_sort_constraints_by_num_terms();
  void set_has_use_random_lns();
  void clear_has_use_random_lns();
  void set_has_random_seed();
  void clear_has_random_seed();
  void set_has_num_relaxed_vars();
  void clear_has_num_relaxed_vars();
  void set_has_max_number_of_conflicts_in_random_lns();
  void clear_has_max_number_of_conflicts_in_random_lns();
  void set_has_num_random_lns_tries();
  void clear_has_num_random_lns_tries();
  void set_has_max_number_of_backtracks_in_ls();
  void clear_has_max_number_of_backtracks_in_ls();
  void set_has_use_lp_lns();
  void clear_has_use_lp_lns();
  void set_has_use_sat_to_choose_lns_neighbourhood();
  void clear_has_use_sat_to_choose_lns_neighbourhood();
  void set_has_max_number_of_conflicts_for_quick_check();
  void clear_has_max_number_of_conflicts_for_quick_check();
  void set_has_use_symmetry();
  void clear_has_use_symmetry();
  void set_has_exploit_symmetry_in_sat_first_solution();
  void clear_has_exploit_symmetry_in_sat_first_solution();
  void set_has_max_number_of_conflicts_in_random_solution_generation();
  void clear_has_max_number_of_conflicts_in_random_solution_generation();
  void set_has_max_number_of_explored_assignments_per_try_in_ls();
  void clear_has_max_number_of_explored_assignments_per_try_in_ls();
  void set_has_use_transposition_table_in_ls();
  void clear_has_use_transposition_table_in_ls();
  void set_has_use_potential_one_flip_repairs_in_ls();
  void clear_has_use_potential_one_flip_repairs_in_ls();
  void set_has_use_learned_binary_clauses_in_lp();
  void clear_has_use_learned_binary_clauses_in_lp();
  void set_has_number_of_solvers();
  void clear_has_number_of_solvers();
  void set_has_synchronization_type();
  void clear_has_synchronization_type();
  void set_has_default_solver_optimizer_sets();
  void clear_has_default_solver_optimizer_sets();
  void set_has_use_lp_strong_branching();
  void clear_has_use_lp_strong_branching();
  void set_has_decomposer_num_variables_threshold();
  void clear_has_decomposer_num_variables_threshold();
  void set_has_num_bop_solvers_used_by_decomposition();
  void clear_has_num_bop_solvers_used_by_decomposition();
  void set_has_decomposed_problem_min_time_in_seconds();
  void clear_has_decomposed_problem_min_time_in_seconds();
  void set_has_guided_sat_conflicts_chunk();
  void clear_has_guided_sat_conflicts_chunk();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<2> _has_bits_;
  ::google::protobuf::RepeatedPtrField< ::operations_research::bop::BopSolverOptimizerSet > solver_optimizer_sets_;
  static ::google::protobuf::internal::ExplicitlyConstructed< ::std::string> _default_default_solver_optimizer_sets_;
...
inline void BopParameters::clear_default_solver_optimizer_sets() {
  default_solver_optimizer_sets_.ClearToDefaultNoArena(&BopParameters::_default_default_solver_optimizer_sets_.get());
...
inline void BopParameters::set_default_solver_optimizer_sets(const ::std::string& value) {
  ...
  default_solver_optimizer_sets_.SetNoArena(&BopParameters::_default_default_solver_optimizer_sets_.get(), value);
...
inline void BopParameters::set_default_solver_optimizer_sets(::std::string&& value) {
  ...
  default_solver_optimizer_sets_.SetNoArena(
    &BopParameters::_default_default_solver_optimizer_sets_.get(), std::move(value));
...
inline void BopParameters::set_default_solver_optimizer_sets(const char* value) {
  set_has_default_solver_optimizer_sets();
  default_solver_optimizer_sets_.SetNoArena(&BopParameters::_default_default_solver_optimizer_sets_.get(), ::std::string(value));
...
inline void BopParameters::set_default_solver_optimizer_sets(const char* value, size_t size) {
  set_has_default_solver_optimizer_sets();
  default_solver_optimizer_sets_.SetNoArena(&BopParameters::_default_default_solver_optimizer_sets_.get(),
...
inline ::std::string* BopParameters::mutable_default_solver_optimizer_sets() {
  ...
  return default_solver_optimizer_sets_.MutableNoArena(&BopParameters::_default_default_solver_optimizer_sets_.get());
}
inline ::std::string* BopParameters::release_default_solver_optimizer_sets() {
  ...
  clear_has_default_solver_optimizer_sets();
  return default_solver_optimizer_sets_.ReleaseNoArena(&BopParameters::_default_default_solver_optimizer_sets_.get());
}
inline void BopParameters::set_allocated_default_solver_optimizer_sets(::std::string* default_solver_optimizer_sets) {
  ...
  default_solver_optimizer_sets_.SetAllocatedNoArena(&BopParameters::_default_default_solver_optimizer_sets_.get(), default_solver_optimizer_sets);
...
#endif  // PROTOBUF_ortools_2fbop_2fbop_5fparameters_2eproto__INCLUDED
